...

{
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/mixin/media.js
     */
    const Media = (() => {
        const {createEvent, css, isNumeric, isString, on, startsWith, toFloat, trigger} = UIkit.util;
        ...
        return uikitComponentType({
            ...
            computed: {
                ...
                matchMedia() {
                    ...
                    const mediaMax = toMedia(this.mediaMax, this.$el, 'max');
        ...
        function toMedia(value, element, min = 'min') {
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/core/height-viewport.js
     */
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/core/sticky.js
     */
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/core/svg.js
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/util/dom.js
     */
    const InputNumber = (() => {
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/components/countdown.js
     */
    const NewCountdown = (() => {
    ...
    /**
     * @see https://github.com/uikit/uikit/blob/v3.19.2/src/js/core/drop.js
     */
    const NewDrop = (() => {
